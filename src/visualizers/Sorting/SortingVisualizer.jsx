...
export default function SortingVisualizer() {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6">
      <h2 className="text-2xl font-bold text-indigo-700 mb-1">Sorting Visualizer</h2>
      <p className="text-gray-500 text-sm mb-6">Watch sorting algorithms work step by step</p>

      {/* Bar chart */}
      <div className="flex items-end gap-2 justify-center h-48 mb-6 bg-gray-50 rounded-lg p-4">
        {arr.map((val, i) => (
      ...
      {/* Complexity table */}
      <div className="mt-8 bg-gray-50 border rounded-lg p-4 text-sm">
        <p className="font-semibold mb-3 text-gray-800">Time Complexity</p>
